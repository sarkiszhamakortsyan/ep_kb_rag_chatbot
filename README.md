...
backend/
  app/
    ...
    core/           settings (pydantic-settings), JSON logging, admin token check
...
frontend/src/
  ...
  features/admin/   admin area: sign-in, Statistics and History tabs, answer details
documentation/
...
- **Planned** (with the seams already in the code, see [`ideas.md`](documentation/taskdocs/ideas.md)): costs and tests tabs; concise vs detailed answers; a model on/off toggle. The response history and statistics are built on this branch.
